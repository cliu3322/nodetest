...
module.exports = (sequelize, DataTypes) => {
  var attributes = {
    ...
    approved_USD: DataTypes.FLOAT,
    approved_reimbusement: DataTypes.FLOAT,
    Reject_USD: DataTypes.FLOAT,
    benefitArea: DataTypes.INTEGER

  }
  for (var i = 1; i < 42; i++) {
    attributes[i] = DataTypes.FLOAT
  }
  const Dirty = sequelize.define('Dirty', attributes, {});
  Dirty.associate = function(models) {
  };
  return Dirty;
};
